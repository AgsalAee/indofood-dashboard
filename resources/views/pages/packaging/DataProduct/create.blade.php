        ...
        <form action="{{ route('DataProduct.store') }}" method="POST">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input class="bg-white-200 text-black" type="text" name="product_id" class="form-control"
                ...
                <div class="form-group">
                    <strong>Bobot BG:</strong>
                    <input class="bg-white-200 text-black" type="text" name="product_bg_weight" class="form-control"
                        placeholder="Bobot BG (Jika tidak ada kosongkan/beri 0)">
                </div>
                <div class="form-group">
                    <strong>Bobot SI:</strong>
